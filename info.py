...
BOT_TOKEN = environ.get('BOT_TOKEN', '5875909884:AAF0kER1dLUGwFabosrF1zNjTtygs_YkpnU')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '351170421 5977113116 5845960615').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://irfanmama:irfanmama@cluster0.amfvame.mongodb.net/?retryWrites=true&w=majority")
...
# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001693527538'))
