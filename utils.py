...
from info import AUTH_CHANNEL, LONG_IMDB_DESCRIPTION, MAX_LIST_ELM, CUSTOM_FILE_CAPTION, REQ_CHANNEL, ADMINS
    ...
    for file in files:
        ...
        await bot.send_cached_media(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                    InlineKeyboardButton('Gʀᴏᴜᴘ', url='https://t.me/cinema_kottaka_group'),
